...
public class FlyingController : Component
{
	/// <summary>
	/// How fast you fly
	/// </summary>
	...
	protected override void OnFixedUpdate()
	{
		...
		var wishVelocity = Input.AnalogMove.Normal * wishSpeed * Transform.Rotation + Vector3.Up * wishVerticalSpeed;

		Transform.Position += wishVelocity;
	}
}
